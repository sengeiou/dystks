...
export class InstApi{
    ...
    addksjl(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/addksjl',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    getshijuan(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/getshijuan',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    gettimu(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/gettimu',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    kemu(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/kemu',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    kemuleibie(json, callback, showLoading = true) {
    ...
    ksjlph(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/ksjlph',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    ksjlph1(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/ksjlph1',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
